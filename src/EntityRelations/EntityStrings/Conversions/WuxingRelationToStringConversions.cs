...
/// <summary>
/// 提供一些针对 <seealso cref="WuxingRelation"/> 的 <seealso cref="ConversionToString{T}"/> 样例。
/// Provides some samples of <seealso cref="ConversionToString{T}"/> of <seealso cref="WuxingRelation"/>s.
/// </summary>
public static class WuxingRelationToStringConversions
{
    ...
    /// </summary>
    public static ConversionToString<WuxingRelation> InChinese { get; }
        = (relationship) =>
        {
    ...
    /// </summary>
    public static ConversionToString<WuxingRelation> LiuqinInEnglish { get; }
        = (relationship) =>
        {
            return relationship switch
            {
    ...
    /// </summary>
    public static ConversionToString<WuxingRelation> Liuqin { get; }
        = (relationship) =>
        {
            return relationship switch
            {
