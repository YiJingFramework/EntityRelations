...
public class GuaDerivationExtensionsTests
{
    ...
    public void ChangeLinesTest()
    {
        ...
        _ = Assert.ThrowsException<ArgumentOutOfRangeException>(() => Gua.Parse("101").ChangeLines(
            new[] { 0, 2, 3, -234, 1239109 }));

        Assert.AreEqual(Gua.Parse(""), Gua.Parse("").ChangeLines(new[] { 1, 2, 3 }, false));
        ...
        Assert.AreEqual(GuaTrigram.Parse("000"), GuaTrigram.Parse("101").ChangeLines(
            new[] { 0, 2, 3, -234, 1239109 }, false));
        _ = Assert.ThrowsException<ArgumentOutOfRangeException>(() => GuaTrigram.Parse("101").ChangeLines(
            new[] { 0, 2, 3, -234, 1239109 }));
        _ = Assert.ThrowsException<ArgumentNullException>(() => ((GuaTrigram?)null)!.ChangeLines());
    }
